...
- Notes are internal-only; contacts do not receive them.
- Tag or mention teammates if supported to draw attention.
...
## Best practice 💡
- Add concise context (what happened, what’s needed) to speed handoffs.
- Use notes before reassigning or closing to keep history clear.
