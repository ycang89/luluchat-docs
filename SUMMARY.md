...
* [Inbox](inbox/index.md)
  * [Connect your Channel](inbox/connect-channel.md)
    * [WhatsApp Personal](inbox/connect-whatsapp-personal.md)
    * [WhatsApp Cloud](inbox/connect-whatsapp-cloud.md)
    * [WhatsApp Coexistence](inbox/connect-whatsapp-coexistence.md)
...
* [Automations](automations/index.md)
  * [Message Flows](automations/message-flows.md)
    ...
    * [Shopify App Event Trigger](automations/shopify-app-event-trigger.md)
...
* [Settings](settings/index.md)
  ...
  * [Account Management](settings/account/index.md)
    ...
    * [Integration](settings/account/integration.md)
        ...
        * [Google Calendar Integration](settings/account/google-calendar-integration.md)
