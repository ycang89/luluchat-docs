...
{% hint style="info" %}
This feature is only available for **WhatsApp Cloud (WABA)** channels, not WhatsApp Personal. It may be rolled out behind product access; if you do not see calling options, contact your administrator or Luluchat support.
{% endhint %}
...
The following summarizes Meta’s public Calling API behavior as commonly documented by BSPs and help centers (for example [Wati — WhatsApp Calling restrictions and guidelines](https://support.wati.io/en/articles/12546668-understanding-whatsapp-calling-restrictions-and-guidelines)). Exact numbers can change—verify on Meta if your use case is borderline.
...
- [Understanding WhatsApp Calling restrictions and guidelines (Wati Help Center)](https://support.wati.io/en/articles/12546668-understanding-whatsapp-calling-restrictions-and-guidelines) — BSP summary aligned with Meta’s Calling API behavior; useful for permission limits, regions, and call frequency.
