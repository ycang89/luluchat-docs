# Setup WABA Template for Form Response
...
<figure><img src="../.gitbook/assets/Screenshot 2026-01-24 at 7.28.52 PM.png" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="../.gitbook/assets/Screenshot 2026-01-24 at 7.24.54 PM.png" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
1. **Template name**: Enter `form_response_template`.
2. **Language**: Choose the language you normally use for your customers (for example, English).

<figure><img src="../.gitbook/assets/Screenshot 2026-01-24 at 7.32.31 PM.png" alt=""><figcaption></figcaption></figure>

3. **Body**: Use the following body text (Meta will show variables as `{{1}}`, `{{2}}` later, but you can write the text first):

```
Hi {{1}}, we’ve successfully received your submission.

You may check out your submitted response using the button below.
```

* `{{1}}` will be a variable that Luluchat fills with the contact’s name later.

4. In Variable Samples, enter "John" for `{{1}}`  for review.

<figure><img src="../.gitbook/assets/Screenshot 2026-01-24 at 7.32.55 PM.png" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
<figure><img src="../.gitbook/assets/Screenshot 2026-01-24 at 7.38.19 PM.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Screenshot 2026-01-24 at 7.38.51 PM.png" alt=""><figcaption></figcaption></figure>
{% endstep %}
...
1. In Luluchat, go to [Message Templates](https://app.luluchat.io/message-templates) to sync the message template&#x20;
2. In Luluchat, go to **Forms** and open the form you want to configure.
3. Go to the **Settings** tab for that form.
4. Find the option **“Select a message template to send response to recipients”**.
...
1. Go to your previous form settings and click **Select message template**.
...
<figure><img src="../.gitbook/assets/Screenshot 2026-01-24 at 7.48.06 PM.png" alt=""><figcaption></figcaption></figure>
...
<figure><img src="../.gitbook/assets/Screenshot 2026-01-24 at 7.48.36 PM.png" alt=""><figcaption></figcaption></figure>
...
2. The form is now configured to:
   ...
   * Include a **button** that opens the form response preview page, for example: `https://form.luluchat.io/preview/123456`

<figure><img src="../.gitbook/assets/Screenshot 2026-01-24 at 7.50.14 PM.png" alt=""><figcaption></figcaption></figure>
...
* **Preview URL format**:
  * The final URL sent to users will follow the format: `https://form.luluchat.io/preview/{{preview_code}}`
